...
@section('title', 'Editar Faixa de Faturamento')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">Editar Faixa de Faturamento</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('faixa-faturamentos.update', $faixaFaturamento) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('label') is-invalid @enderror" 
                                   id="label" name="label" value="{{ old('label', $faixaFaturamento->label) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('valor_min') is-invalid @enderror" 
                                               id="valor_min" name="valor_min" value="{{ old('valor_min', $faixaFaturamento->valor_min) }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('valor_max') is-invalid @enderror" 
                                               id="valor_max" name="valor_max" value="{{ old('valor_max', $faixaFaturamento->valor_max) }}" 
                                               step="0.01" min="0" placeholder="0,00" required>
                                        @error('valor_max')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Atualizar Faixa
                            </button>
                        </div>
                    </form>
                </div>
