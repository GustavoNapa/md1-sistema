                                        ...
                                        <tbody>
                                            @foreach($inscription->documents as $document)
                                                <tr>
                                                    <td>{{ $document->name }}</td>
                                                    <td>{{ $document->type }}</td>
                                                    <td><a href="{{ $document->link }}" target="_blank">Ver Documento</a></td>
                                                    <td>
                                                        <button class="btn btn-sm btn-info" onclick="editarDocumento({{ $document->id }})">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger" onclick="excluirDocumento({{ $document->id }})">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                        ...
                                        <tbody>
                                            @foreach($inscription->bonuses as $bonus)
                                                <tr>
                                                    ...
                                                    <td>{{ $bonus->release_date ? $bonus->release_date->format('d/m/Y') : 'N/A' }}</td>
                                                    <td>{{ $bonus->expiration_date ? $bonus->expiration_date->format('d/m/Y') : 'N/A' }}</td>
                                                    <td>
                                                        <button class="btn btn-sm btn-info" onclick="editarBonus({{ $bonus->id }})">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger" onclick="excluirBonus({{ $bonus->id }})">
                                                            <i class="fas fa-trash"></i>
                                                        </button>
                                                    </td>
                                                </tr>
