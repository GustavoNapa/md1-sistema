...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            'quiz-responses.index' => 'Quiz Responses Index',
            'quiz-responses.show' => 'Quiz Responses Show',
            'quiz-responses.report' => 'Quiz Responses Report',
            'quiz-responses.download' => 'Quiz Responses Download',
        ...
        $roles = [
            ...
            'especialista-suporte-ti' => [
                ...
                'permissions' => [
                    ...
                    'quiz-responses.index', 'quiz-responses.show', 'quiz-responses.report', 'quiz-responses.download',
            ...
            'coordenador-mentoria' => [
                ...
                'permissions' => [
                    ...
                    'payments.store',
                    'quiz-responses.index', 'quiz-responses.show', 'quiz-responses.download',
            ...
            'especialista-suporte-cliente' => [
                ...
                'permissions' => [
                    ...
                    'payments.store',
                    'quiz-responses.index', 'quiz-responses.show', 'quiz-responses.report',
                    'whatsapp.conversations', 'whatsapp.messages', 'whatsapp.sendMessage', 'whatsapp.markAsRead', 'whatsapp.possibleMatches', 'whatsapp.associate', 'whatsapp.unlink',
                ],
            ],
