...
{
    public function show(PreceptorRecord $preceptorRecord)
    {
    ...
    public function update(Request $request, PreceptorRecord $preceptorRecord)
    {
        $validated = $request->validate([
            'nome_preceptor' => 'required|string|max:255',
            'historico_preceptor' => 'nullable|string',
        ...
        $preceptorRecord->update($validated);

        return response()->json([
            'success' => true,
            'message' => 'Registro de preceptor atualizado com sucesso!',
            'data' => $preceptorRecord
        ]);
    }
